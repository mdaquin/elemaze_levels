...
def generate_random():
    ...
    if random.random()< config.p_g_guy:
        ...
        while not found:
            ...
            if level["matrix"][level["fireman_position"]["x"]][level["fireman_position"]["y"]]["color"] != "x" and not (level["fireman_position"]["x"] == level["chest_position"]["x"] and level["fireman_position"]["y"] == level["chest_position"]["y"]):
                found=True
    ...
    if random.random()< config.p_g_guy:
        ...
        while not found:
            ...
            if level["matrix"][level["waterman_position"]["x"]][level["waterman_position"]["y"]]["color"] != "x" and not (level["waterman_position"]["x"] == level["chest_position"]["x"] and level["waterman_position"]["y"] == level["chest_position"]["y"]) and not (level["waterman_position"]["x"] == level["fireman_position"]["x"] and level["waterman_position"]["y"] == level["fireman_position"]["y"]):
                found=True
    ...
    if random.random() < 0.5:
        ...
        if r < 0.20:
            ...
            while not found:
                ...
                if gg["matrix"][gg["fireman_position"]["x"]][gg["fireman_position"]["y"]]["color"] != "x" and not (gg["fireman_position"]["x"] == gg["chest_position"]["x"] and gg["fireman_position"]["y"] == gg["chest_position"]["y"]) and not (gg["fireman_position"]["x"] == gg["earthman_position"]["x"] and gg["earthman_position"]["y"] == gg["fireman_position"]["y"]) and not (gg["fireman_position"]["x"] == gg["waterman_position"]["x"] and gg["fireman_position"]["y"] == gg["waterman_position"]["y"]) and not (gg["fireman_position"]["x"] == gg["airman_position"]["x"] and gg["fireman_position"]["y"] == gg["airman_position"]["y"]):
                    found=True
        elif r < 0.40:
            found=False
            while not found:
                gg["airman_position"] = {"x": random.randint(-1,config.maxx-1), "y": random.randint(0,config.maxy-1)}
                if gg["matrix"][gg["airman_position"]["x"]][gg["airman_position"]["y"]]["color"] != "x" and not (gg["airman_position"]["x"] == gg["chest_position"]["x"] and gg["airman_position"]["y"] == gg["chest_position"]["y"]) and not (gg["airman_position"]["x"] == gg["earthman_position"]["x"] and gg["earthman_position"]["y"] == gg["airman_position"]["y"]) and not (gg["airman_position"]["x"] == gg["waterman_position"]["x"] and gg["airman_position"]["y"] == gg["waterman_position"]["y"]) and not (gg["airman_position"]["x"] == gg["fireman_position"]["x"] and gg["airman_position"]["y"] == gg["fireman_position"]["y"]):
                    found = True
        elif r < 0.60:
            found = False
            while not found:                
                gg["earthman_position"] = {"x": random.randint(-1,config.maxx-1), "y": random.randint(0,config.maxy-1)}
                if gg["matrix"][gg["earthman_position"]["x"]][gg["earthman_position"]["y"]]["color"] != "x" and not (gg["earthman_position"]["x"] == gg["chest_position"]["x"] and gg["earthman_position"]["y"] == gg["chest_position"]["y"]) and not (gg["earthman_position"]["x"] == gg["airman_position"]["x"] and gg["earthman_position"]["y"] == gg["airman_position"]["y"]) and not (gg["earthman_position"]["x"] == gg["waterman_position"]["x"] and gg["earthman_position"]["y"] == gg["waterman_position"]["y"]) and not (gg["earthman_position"]["x"] == gg["fireman_position"]["x"] and gg["earthman_position"]["y"] == gg["fireman_position"]["y"]):
                    found=True
        elif r < 0.80:
            found = False
            while not found:
                gg["waterman_position"] = {"x": random.randint(-1,config.maxx-1), "y": random.randint(0,config.maxy-1)}
                if gg["matrix"][gg["waterman_position"]["x"]][gg["waterman_position"]["y"]]["color"] != "x" and not (gg["waterman_position"]["x"] == gg["chest_position"]["x"] and gg["waterman_position"]["y"] == gg["chest_position"]["y"]) and not (gg["waterman_position"]["x"] == gg["airman_position"]["x"] and gg["waterman_position"]["y"] == gg["airman_position"]["y"]) and not (gg["waterman_position"]["x"] == gg["earthman_position"]["x"] and gg["waterman_position"]["y"] == gg["earthman_position"]["y"]) and not (gg["waterman_position"]["x"] == gg["fireman_position"]["x"] and gg["waterman_position"]["y"] == gg["fireman_position"]["y"]):
                    found = True
        else:
            found = False
            while not found:
